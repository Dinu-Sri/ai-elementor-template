...
const items = [
  ...
  pageItem("Services", 61, "main-services", [
    pageItem("Massage", 62, "services-massage", [
      ...
      pageItem("Head, Neck and Shoulder Massage", 1602, "massage-head-neck-shoulder-massage"),
      pageItem("Cupping Therapy", 1604, "massage-cupping-therapy"),
    ]),
    pageItem("Facial", 65, "services-facial", [
      ...
      pageItem("Face Clean Up", 1052, "facial-clean-up"),
    ]),
    ...
    pageItem("Kids Mani Pedi", 1082, "services-kids"),
