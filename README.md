...
| `plugin/native-elementor-bridge/` | WordPress REST bridge, currently v0.6.0 |
...
```powershell
powershell -ExecutionPolicy Bypass -File .\tools\package-plugin.ps1 -Version 0.6.0
```
...
The REST base is `/wp-json/native-elementor/v1`. The bridge supports pages, templates, Theme Builder conditions, menus, site snapshots, posts, categories, authors, media, Rank Math metadata, cache refresh, and export-back inspection.
